		...
		services: {
			chatbot: {
				...
				spike: {
					case: {
						desc: {
							case: 'Торговая площадка в чат-боте для брокерской компании <b>Spike Brokerage</b>',
							customer: 'Брокерская компания Spike Brokerage: <a href="http://spike-trade.com/ru/">веб-сайт</a>',
							functional: [

const RU = {
	...
	header: {
		...
		contact: 'Заказать со скидкой 10%',
		more: 'Подробнее'
	},
	/*** SEPARATE PAGES ***/
	home: {
	...
	chatbot: {
		...
		developmentPlan: {
			...
			content1: 'Автоматизировать до 80% рутинных задач',
			content2: 'Проводить рассылку по базе подписчиков бота',
			content3: 'Поднять продажи за счет рассылки специальных предложений',
			content4: 'Сократить расходы на бизнес-процессы',
			content5: 'Сократить расходы на бизнес-процессы'
		}
	},
	server: {
			...
			chatbot: {
				cases: [
					...
					},
					{
						...
						desc: 'Торговая площадка в чат-боте для брокерской компании',
						isAlternate: true
					},
					{
						name: 'sapori-veri',
				...
				spike: {
					case: {
						desc: {
							case: 'Торговая площадка в чат-боте для брокерской компании',
							customer: 'Брокерская компания <b>Spike Brokerage</b>: <a href="http://spike-trade.com/ru/">веб-сайт</a>',
							functional: [
								'Ценовой обзор рынка культур',
								'Отправка заявок на покупку/продажу культур. Пользователь указывает культуру, объём, способ доставки, порт/область, период доставки, стоимость и валюту',
								'Просмотр истории заявок',
								'Возможность связаться с администрацией',
								'Администраторы в админ панели могут просматривать все запросы, выставлять различные фильтры, выгружать отфильтрованную таблицу в Excel документ и просматривать наилучшие предложения для заявок на продажу',
								'Администраторам доступна возможность управлять доступными портами, создавать новые и активировать/деактивировать существующие',
								'Администраторы ведут базу культур и групп культур. Для каждой культуры администратор может обновить ценовой обзор рынка по этой культуре',
								'Просмотр базы пользователей в админ панели',
								'Управление другими администраторами со стороны суперпользователей',
								'Ведение базы партнёров компании, которые предлагают свои условия по покупке/сбыту товаров (индикативы). Управление индикативами происходит в удобной таблице прямо внутри админ панели',
								'Управление контактами для связи с администрацией'
							],
							result: 'Ссылка на рабочий чат-бот: <a href="https://t.me/SpikeBrokerageBot">t.me/SpikeBrokerageBot</a>'
						},
						screens: [
							{ fileName: 'screen1.png', title: 'Стартовый экран' },
							{ fileName: 'screen2.png', title: 'Ценовой обзор рынка' },
							{ fileName: 'screen3.png', title: 'Создание заявки' },
							{ fileName: 'screen4.png', title: 'Создание заявки' },
							{ fileName: 'screen5.png', title: 'История заявок' },
							{ fileName: 'screen6.png', title: 'Контакты администрации' }
						],
						screensFullScreen: [
							{ fileName: 'screen7.png', title: 'Таблица заявок' },
							{ fileName: 'screen8.png', title: 'Таблица портов' },
							{ fileName: 'screen9.png', title: 'Таблица культур' },
							{ fileName: 'screen10.png', title: 'Таблица групп культур' },
							{ fileName: 'screen11.png', title: 'Таблица пользователей' },
							{ fileName: 'screen12.png', title: 'Таблица партнёров' },
							{ fileName: 'screen13.png', title: 'Работа с индикативами партнёров' },
							{ fileName: 'screen14.png', title: 'Таблица администраторов' },
							{ fileName: 'screen15.png', title: 'Таблица контактов' }
						]
					}
				},
				terraprof: {
	...
	promotion: {
		heading: 'Продвижение веб-сайтов',
		content1: {
			text: 'Наша компания предоставляет услуги по разностороннему продвижению веб-сайтов после их разработки под ключ, либо уже готовых веб-ресурсов.'
		},
		content2: {
			text: 'Успех сайтов зависит от метода продвижения: SEO-продвижение, контекстная реклама Google Ads и Яндекс Direct, SMM-продвижение'
		}
	}
}

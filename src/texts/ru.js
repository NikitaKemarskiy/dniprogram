const RU = {
	...
	businessCard: {
		intro: 'Разработка и продвижение эффективных и действенных сайтов-визиток',
		introHeading: 'Получите прибыльный веб-сайт уже сейчас. Перестаньте тратить деньги впустую!',
	...
	corporate: {
		...
		introHeading: 'Получите прибыльный и действенный веб-сайт уже сейчас. Перестаньте тратить деньги впустую!',
		heading: 'Что вы получаете?',
	...
	chatbot: {
		name: 'Чат-бот',
		intro: 'Dniprogram',
		introHeading: 'Профессиональная разработка чат-ботов Telegram, Viber, Facebook под заказ',
		heading: 'Что вы получаете?',
